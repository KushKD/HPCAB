...
public class SendToListAdapter extends ArrayAdapter<SendToList> {
    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<SendToList> values;

    public SendToListAdapter(Context context, int textViewResourceId, List<SendToList> values) {
    ...
    public SendToList getItem(int position) {
