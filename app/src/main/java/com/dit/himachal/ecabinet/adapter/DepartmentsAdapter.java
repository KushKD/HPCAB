...
public class DepartmentsAdapter extends ArrayAdapter<DepartmentsPojo> {
    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<DepartmentsPojo> values;

    public DepartmentsAdapter(Context context, int textViewResourceId, List<DepartmentsPojo> values) {
    ...
    public DepartmentsPojo getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getDeptName());
