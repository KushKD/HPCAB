...
public class UsersAdapter extends ArrayAdapter<UserPojo> {
    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<UserPojo> values;

    public UsersAdapter(Context context, int textViewResourceId, List<UserPojo> values) {
