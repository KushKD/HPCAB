...
import com.dit.himachal.ecabinet.modal.CaseNoticesByAdvocatePojo;
import com.dit.himachal.ecabinet.modal.CauseListPojo;

import java.util.ArrayList;
import java.util.List;

public class NoticesAdvocateAdapter extends BaseAdapter implements Filterable {

    private Context context;
    private List<CaseNoticesByAdvocatePojo> news;

    private Filter planetFilter;
    private List<CaseNoticesByAdvocatePojo> origUserList;
     ...
     * @param objects
     */
    public NoticesAdvocateAdapter(Context context, List<CaseNoticesByAdvocatePojo> objects) {
     ...
     */
    @Override
    public CaseNoticesByAdvocatePojo getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CaseNoticesByAdvocatePojo u = news.get(position);
    ...
    public Filter getFilter() {
        if (planetFilter == null)
            planetFilter = new NoticesAdvocateAdapter.PlanetFilter();
    ...
    private class PlanetFilter  extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                List<CaseNoticesByAdvocatePojo> nPlanetList = new ArrayList<>();

                for (CaseNoticesByAdvocatePojo p : news) {
...
//                    }
        ...
        protected void publishResults(CharSequence constraint,
            ...
            if (results.count == 0)
                ...
                news = (List<CaseNoticesByAdvocatePojo>) results.values;
